    ...
    private fun configTestimonios() {
        ...
        binding?.let { it ->
            it.cardTestimonios.apply {
                bindTestimonio(configTestimonios(),list[0])
                bindTestimonio(configTestimonios(), list[1])
                bindTestimonio(configTestimonios(), list[2])
                bindTestimonio(configTestimonios(), list[3])
            }
        }
